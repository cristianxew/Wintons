...
const myAccountPageTemplate = require.resolve(
  `../src/templates/my-account/index.js`
);
...
query GET_PAGES {
  ...
  categories: allWpProductCategory (filter: {image: {title: {eq: "image-slider"}}}, limit: 10) {
    nodes {
      id
      name
      uri
